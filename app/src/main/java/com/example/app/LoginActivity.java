...
//                String pas_email = password.getText().toString();
                loginController.bCreate(email.getText().toString(),password.getText().toString());
...
//                    Toast.makeText(LoginActivity.this, "you need more than 6 chars", Toast.LENGTH_LONG).show();
//                }
//                else{
