...
public class MainModel {
    ...
    public MainModel(ArrayList<Site> shapeList, MainMV mainMV, ShapeAdapter adapter) {
        ...
        fstore.collection("Users").document(uid).get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                ...
                public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                    ...
                    if(doc.exists()){
                        ...
                        getAndPopEvent(usr.getEvents(),mainActivity);
                    }
                }
            });
    }

    private void getAndPopEvent(ArrayList<EventID> eventID, MainActivity mainActivity) {
        ArrayList<String> msg = new ArrayList<String>();
        ArrayAdapter<String> adapterEvent = new ArrayAdapter<String>(mainActivity, android.R.layout.simple_list_item_1, msg);
        ...
        mainMV.getTheEvent(adapterEvent);
