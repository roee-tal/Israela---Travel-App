...
//import com.example.app.controller.GetUserTask;
...
//        nav = findViewById(R.id.bottom_nav_admi);
        ...
        detailUserController = new DetailUserController(this);
        ...
        new AlertDialog.Builder(this).setMessage("Are you sure you want to delete?").
                setCancelable(false).setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        detailUserController.bDelete(parsedStringID);
...
//                Log.d("dasasdas", gsc.toString());
//                switch (item.getItemId()) {
//                    case R.id.sign_out_admin:
//
//                        areYouSureMessageOut(gsc);
//                        break;
//
//                    case R.id.u:
...
//    private void areYouSureMessageOut(GoogleSignInClient gsc) {
...
//                        showToastAndSignOut.signOut(DetailUserActivity.this.gsc,DetailUserActivity.this);
////                        signOut();
//                    }
//                })
//                .setNegativeButton("No", null).show();
...
//        detailUserController.getParsedUser(parsedStringID);
...
//
//        try {
//            new GetUserTask(detailUserController,this).execute(parsedID);//            User user = detailUserController.getPUser(parsedID);
//            Intent previousIntent = getIntent();
//            String parsedStringID = previousIntent.getStringExtra("id2");
////            Log.d("ARTE",parsedStringID);
//            TextView siteName = (TextView) findViewById(R.id.Email);
//            siteName.setText(parsedStringID);
